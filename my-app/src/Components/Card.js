...
return(<React.Fragment>
    <div className="w-4/5 pl-20">
        <h1 className="text-3xl text-gray-600">{metier}</h1>
         ...
         <div>{
            notes.map((note)=><div className="flex flex-row items-center py-4"><BiChevronsRight className="text-blue-600 pr-2" size={50}/><span className="text-gray-600">{note}</span></div>)
         }</div>
